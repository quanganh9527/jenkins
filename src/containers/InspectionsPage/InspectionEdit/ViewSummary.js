  ...
  return (
    <Container>
            ...
            <Col>
              ...
              {isSubmitting && !debtorContact && (
                <FormFeedback className="d-block">
                  <FormattedMessage id="components.errors.invoiceContact.require" />
                </FormFeedback>
              )}
            </Col>
          </FormGroup>
      ...
      <Row>
        <Col>
          <CardTitle>
            <FormattedMessage id="pages.inspection.sendInspectionTo" />
          </CardTitle>
          ...
          <FormGroup row>
            <Col>
              ...
              {isSubmitting && (!contacts || contacts.length < 1) && (
                <FormFeedback className="d-block">
                  <FormattedMessage id="components.errors.contacts.require" />
                </FormFeedback>
              )}
            </Col>
          </FormGroup>
