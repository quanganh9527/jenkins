...
import { validationInspectionMaintenance } from "./validation";
...
const ROLE_INSPECTOR = "mechanic";
function MaintenanceNew({ intl, jobType }) {
  ...
  const { inspectors, notificationMaintenance } = inspectionState;
  ...
  const {
    ...
    validationSchema: validationInspectionMaintenance(intl),
  });
  // custom validation
  ...
  const handleChangeDate = async (date) => {
    ...
    if (date && errors.dateInspection && errors.dateInspection.message) {
      ...
      setError(
        ...
        "notMatch",
        intl.formatMessage({
          id: "pages.maintenance.errors.dateOfMaintenanceJob.require",
        }),
      );
    }
  };
  ...
  const handleSubmitInspection = (values) => {
    ...
    if (values.units.length > 0 && existedLocationsNoPoint.length > 0) {
      ...
      dispatch(inspectionActions.submitOpenNewMaintenance(values));
    }
  };
  ...
  return (
    <Fragment>
      <PageTitle
        heading={<FormattedMessage id="components.pageTitle.newMaintenance" />}
          ...
          <Card className="main-card mb-3">
            <CardHeader className="w-100">
              <div className="w-100 d-flex justify-content-between">
                <p className="my-auto">
                  <FormattedMessage id="components.formTitle.openNewMaintenance" />
                </p>
              ...
              <Col md="10" className="mx-auto">
                ...
                <Row form>
                  ...
                  <Col md={6} className="z-index-7">
                    <FormGroup>
                      <Label for="">
                        <FormattedMessage id="pages.maintenance.dayOfInspection" />
                      </Label>
                      <InputGroup>
                        <DatePicker
                          selected={startDate}
                  ...
                  <Col md={12} className="z-index-6">
                    <FormGroup>
                      ...
                      <TextareaAutosize
                        ...
                        placeholder={intl.formatMessage({
                          id:
                            "components.input.placeholder.typeInstructionsDescMaintenance",
                        })}
                        name="instructions"
                        value={instructions}
                        onChange={({ target }) => {
                ...
                <Row>
                  <Col md={12}>
                    <FormGroup>
                      <Label for="">
                        <FormattedMessage id="pages.maintenance.inspectionPoints" />
                      </Label>
      ...
      <DialogConfirmDeleteEmtyInspectionPoint
        ...
        warnMessageKey="components.dialog.confirmDeleteMaintenancePoint.desc"
      />
    </Fragment>
  );
}

export default injectIntl(MaintenanceNew);
