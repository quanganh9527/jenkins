...
function ViewSummaryMaintenance({
  intl,
  inspection,
  ...
  return (
    <Container>
      ...
      <Row className="mt-2">
        <Col>
          ...
          !find(inspection.units, (unit) =>
            ...
            <p>
              {intl.formatMessage({ id: "pages.maintenance.noExpenditures" })}
            </p>
          ) : (
            map(
            ...
            <Col>
              ...
              {isSubmitting && !debtorContact && (
                <FormFeedback className="d-block">
                  {intl.formatMessage({
                    id: "pages.maintenance.errors.invoiceContact.require",
                  })}
                </FormFeedback>
              )}
            </Col>
      ...
      <Row>
        <Col>
          <CardTitle>
            <FormattedMessage id="pages.maintenance.sendMaintenanceTo" />
          </CardTitle>
          ...
          <FormGroup row>
            <Col>
              ...
              {isSubmitting && (!contacts || contacts.length < 1) && (
                <FormFeedback className="d-block">
                  {intl.formatMessage({
                    id: "pages.maintenance.errors.contacts.require",
                  })}
                </FormFeedback>
              )}
            </Col>
...
export default memo(ViewSummaryMaintenance);
